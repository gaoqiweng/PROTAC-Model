...
def frodock(site):
    ...
    os.system(FRODOCK + '/bin/frodockgrid receptor.pdb -o receptor_W.ccp4')

    os.system('echo STAGE-2 Creation of the receptor electrostatic potential map')
    os.system(FRODOCK + '/bin/frodockgrid receptor.pdb -o receptor_E.ccp4 -m 1 -t E')

    os.system('echo STAGE-3 Creation of the receptor desolvation potential map')
    os.system(FRODOCK + '/bin/frodockgrid receptor.pdb -o receptor_DS.ccp4 -m 3')

    os.system('echo STAGE-4 Creation of the target desolvation potential map')
    os.system(FRODOCK + '/bin/frodockgrid target.pdb -o target_DS.ccp4 -m 3')

    os.system('echo STAGE-5 Performing the docking')
    os.system(FRODOCK + '/bin/frodock receptor_ASA.pdb target_ASA.pdb -w receptor_W.ccp4 -e receptor_E.ccp4 '
    ...
    os.system(FRODOCK + '/bin/frodockcluster dock.dat target.pdb -o clust_dock_4.dat -d 4')

    os.system('echo STAGE-8 Coordinate generation of the best predicted solutions')
    os.system(FRODOCK + '/bin/frodockview clust_dock_4.dat -p target.pdb >> frodock_score.txt')
